...
public class AddressBookProvider extends ContentProvider
{
	...
	public static String resolveLabel(final Context context, @Nonnull final String address)
	{
		...
		final Uri uri = contentUri(BuildConfig.APPLICATION_ID).buildUpon().appendPath(address).build();
	...
	public Uri insert(final Uri uri, final ContentValues values)
	{
		...
		final Uri rowUri = contentUri(BuildConfig.APPLICATION_ID).buildUpon().appendPath(address).appendPath(Long.toString(rowId)).build();
