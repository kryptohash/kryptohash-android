...
import com.github.kryptohash.kryptohashj.core.AbstractPeerEventListener;
import com.github.kryptohash.kryptohashj.core.Address;
import com.github.kryptohash.kryptohashj.core.Block;
import com.github.kryptohash.kryptohashj.core.BlockChain;
import com.github.kryptohash.kryptohashj.core.CheckpointManager;
import com.github.kryptohash.kryptohashj.core.Coin;
import com.github.kryptohash.kryptohashj.core.Peer;
import com.github.kryptohash.kryptohashj.core.PeerEventListener;
import com.github.kryptohash.kryptohashj.core.PeerGroup;
...
import com.github.kryptohash.kryptohashj.net.discovery.DnsDiscovery;
...
import com.github.kryptohash.kryptohashj.store.SPVBlockStore;
...
public class BlockchainServiceImpl extends android.app.Service implements BlockchainService
{
			...
			handler.post(new Runnable()
			{
				...
				public void run()
				{
					...
					else
					{
						...
						notification.setSmallIcon(getResources().getIdentifier("stat_sys_peers_" + (numPeers > 4 ? 4 : numPeers), "drawable", BuildConfig.APPLICATION_ID));
						notification.setContentTitle(getString(R.string.app_name));
						notification.setContentText(getString(R.string.notification_peers_connected_msg, numPeers));
						notification.setContentIntent(PendingIntent.getActivity(BlockchainServiceImpl.this, 0, new Intent(BlockchainServiceImpl.this, WalletActivity.class), 0));
						notification.setWhen(System.currentTimeMillis());
	...
	public int onStartCommand(final Intent intent, final int flags, final int startId)
	{
		if (intent != null)
		{
			...
			{
				final Shake320Hash hash = new Shake320Hash(intent.getByteArrayExtra(BlockchainService.ACTION_BROADCAST_TRANSACTION_HASH));
