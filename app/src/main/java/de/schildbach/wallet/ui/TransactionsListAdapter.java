...
import com.github.kryptohash.kryptohashj.core.Transaction.Purpose;
...
import com.github.kryptohash.kryptohashj.wallet.DefaultCoinSelector;
...
public class TransactionsListAdapter extends BaseAdapter
{
	...
	public long getItemId(final int position)
	{
		...
		return WalletUtils.longHash320(transactions.get(position).getHash());
	}
	...
	private Map<Shake320Hash, TransactionCacheEntry> transactionCache = new HashMap<Shake320Hash, TransactionCacheEntry>();
