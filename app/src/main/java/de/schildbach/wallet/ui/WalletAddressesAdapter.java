...
public class WalletAddressesAdapter extends BaseAdapter
{
	...
	private final List<Ed25519Key> keys = new ArrayList<Ed25519Key>();
	...
	public void replace(@Nonnull final Collection<Ed25519Key> keys)
	{
		this.keys.clear();
	...
	{
		final Ed25519Key key = (Ed25519Key) getItem(position);
