...
public final class RequestWalletBalanceTask
{
			...
			public void run()
			{
				...
				try
				{
					...
					if (responseCode == HttpURLConnection.HTTP_OK)
					{
						...
						final Map<Shake320Hash, Transaction> transactions = new HashMap<Shake320Hash, Transaction>(jsonOutputs.length());
						...
						for (int i = 0; i < jsonOutputs.length(); i++)
						{
							...
							final Shake320Hash uxtoHash = new Shake320Hash(jsonOutput.getString("transaction_hash"));
	...
	{
		private final Shake320Hash hash;

		public FakeTransaction(final NetworkParameters params, final Shake320Hash hash)
		{
			super(params);
			this.hash = hash;
		}
