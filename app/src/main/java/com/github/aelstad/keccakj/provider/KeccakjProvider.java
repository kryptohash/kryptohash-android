...
public final class KeccakjProvider extends Provider {
	...
	public KeccakjProvider() {
		super("com.github.aelstad.keccakj", 1.0, "Implementation of digests, ciphers and random generated based on the Keccak permutation. Includes SHA3 digests");
		...
		put(messageDigestPrefix + Constants.SHAKE160, "com.github.aelstad.keccakj.kryptohash.Shake160");		
		put(messageDigestPrefix + Constants.SHAKE320, "com.github.aelstad.keccakj.kryptohash.Shake320");		
