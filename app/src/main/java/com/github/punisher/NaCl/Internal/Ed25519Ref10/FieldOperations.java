package com.github.punisher.NaCl.Internal.Ed25519Ref10;
...
public class FieldOperations
{
    ...
    public static void fe_add(FieldElement h, FieldElement f, FieldElement g)
    {
        int f0 = f.x0;
        int f1 = f.x1;
        int f2 = f.x2;
    ...
    public static void fe_cmov(FieldElement f, FieldElement g, int b)
    {
        int f0 = f.x0;
        int f1 = f.x1;
        int f2 = f.x2;
    ...
    public static long load_3(byte[] data, int offset)
    {
        /*
         * int result; result = (int) (data[offset + 0] & 0xFF); result |=
         * (((int) data[offset + 1]& 0xFF) << 8); result |= (((int) data[offset
         * + 2]& 0xFF) << 16); return (long) (long) result;
         */

        return (long) (data[offset + 0] & 0xFF) | (((long) (data[offset + 1]) & 0xFF) << 8) | (((long) (data[offset + 2]) & 0xFF) << 16);
    }

    public static long load_4(byte[] data, int offset)
    {
        /*
         * int result; result = (int) (data[offset + 0] & 0xFF); result |=
         * (((int) data[offset + 1]& 0xFF) << 8); result |= (((int) data[offset
         * + 2]& 0xFF) << 16); result |= (((int) data[offset + 3]& 0xFF) << 24);
         * return (long) (long) result;
         */

        return (long) (data[offset + 0] & 0xFF) | (((long) (data[offset + 1]) & 0xFF) << 8) | (((long) (data[offset + 2]) & 0xFF) << 16) | (((long) (data[offset + 3]) & 0xFF) << 24);
    }

    // Ignores top bit of h.
    public static void fe_frombytes(FieldElement h, byte[] data, int offset)
    {
    ...
    public static void fe_frombytes2(FieldElement h, byte[] data, int offset)
    {
        long h0 = load_4(data, offset);
        long h1 = load_3(data, offset + 4) << 6;
        long h2 = load_3(data, offset + 7) << 5;
    ...
    public static void fe_invert(FieldElement result, FieldElement z)
    {
        ...
        /* qhasm: z2 = z1^2^1 */
        /*
         * asm 1: fe_sq(>z2=fe#1,<z1=fe#11); for (i = 1;i < 1;++i)
         * fe_sq(>z2=fe#1,>z2=fe#1);
         */
        /*
         * asm 2: fe_sq(>z2=t0,<z1=z); for (i = 1;i < 1;++i)
         * fe_sq(>z2=t0,>z2=t0);
         */
        ...
        /* qhasm: z8 = z2^2^2 */
        /*
         * asm 1: fe_sq(>z8=fe#2,<z2=fe#1); for (i = 1;i < 2;++i)
         * fe_sq(>z8=fe#2,>z8=fe#2);
         */
        /*
         * asm 2: fe_sq(>z8=t1,<z2=t0); for (i = 1;i < 2;++i)
         * fe_sq(>z8=t1,>z8=t1);
         */
        fe_sq(t1, t0);
        for (i = 1; i < 2; ++i)
        ...
        /* qhasm: z22 = z11^2^1 */
        /*
         * asm 1: fe_sq(>z22=fe#3,<z11=fe#1); for (i = 1;i < 1;++i)
         * fe_sq(>z22=fe#3,>z22=fe#3);
         */
        /*
         * asm 2: fe_sq(>z22=t2,<z11=t0); for (i = 1;i < 1;++i)
         * fe_sq(>z22=t2,>z22=t2);
         */
        ...
        /*
         * asm 1: fe_sq(>z_10_5=fe#3,<z_5_0=fe#2); for (i = 1;i < 5;++i)
         * fe_sq(>z_10_5=fe#3,>z_10_5=fe#3);
         */
        /*
         * asm 2: fe_sq(>z_10_5=t2,<z_5_0=t1); for (i = 1;i < 5;++i)
         * fe_sq(>z_10_5=t2,>z_10_5=t2);
         */
        fe_sq(t2, t1);
        for (i = 1; i < 5; ++i)
            fe_sq(t2, t2);
        ...
        /*
         * asm 1: fe_sq(>z_20_10=fe#3,<z_10_0=fe#2); for (i = 1;i < 10;++i)
         * fe_sq(>z_20_10=fe#3,>z_20_10=fe#3);
         */
        /*
         * asm 2: fe_sq(>z_20_10=t2,<z_10_0=t1); for (i = 1;i < 10;++i)
         * fe_sq(>z_20_10=t2,>z_20_10=t2);
         */
        fe_sq(t2, t1);
        for (i = 1; i < 10; ++i)
            fe_sq(t2, t2);
        ...
        /*
         * asm 1: fe_sq(>z_40_20=fe#4,<z_20_0=fe#3); for (i = 1;i < 20;++i)
         * fe_sq(>z_40_20=fe#4,>z_40_20=fe#4);
         */
        /*
         * asm 2: fe_sq(>z_40_20=t3,<z_20_0=t2); for (i = 1;i < 20;++i)
         * fe_sq(>z_40_20=t3,>z_40_20=t3);
         */
        fe_sq(t3, t2);
        for (i = 1; i < 20; ++i)
            fe_sq(t3, t3);
        ...
        /*
         * asm 1: fe_sq(>z_50_10=fe#3,<z_40_0=fe#3); for (i = 1;i < 10;++i)
         * fe_sq(>z_50_10=fe#3,>z_50_10=fe#3);
         */
        /*
         * asm 2: fe_sq(>z_50_10=t2,<z_40_0=t2); for (i = 1;i < 10;++i)
         * fe_sq(>z_50_10=t2,>z_50_10=t2);
         */
        fe_sq(t2, t2);
        for (i = 1; i < 10; ++i)
            fe_sq(t2, t2);
        ...
        /*
         * asm 1: fe_sq(>z_100_50=fe#3,<z_50_0=fe#2); for (i = 1;i < 50;++i)
         * fe_sq(>z_100_50=fe#3,>z_100_50=fe#3);
         */
        /*
         * asm 2: fe_sq(>z_100_50=t2,<z_50_0=t1); for (i = 1;i < 50;++i)
         * fe_sq(>z_100_50=t2,>z_100_50=t2);
         */
        fe_sq(t2, t1);
        for (i = 1; i < 50; ++i)
            fe_sq(t2, t2);
        ...
        /*
         * asm 1: fe_sq(>z_200_100=fe#4,<z_100_0=fe#3); for (i = 1;i < 100;++i)
         * fe_sq(>z_200_100=fe#4,>z_200_100=fe#4);
         */
        /*
         * asm 2: fe_sq(>z_200_100=t3,<z_100_0=t2); for (i = 1;i < 100;++i)
         * fe_sq(>z_200_100=t3,>z_200_100=t3);
         */
        fe_sq(t3, t2);
        for (i = 1; i < 100; ++i)
            fe_sq(t3, t3);
        ...
        /*
         * asm 1: fe_sq(>z_250_50=fe#3,<z_200_0=fe#3); for (i = 1;i < 50;++i)
         * fe_sq(>z_250_50=fe#3,>z_250_50=fe#3);
         */
        /*
         * asm 2: fe_sq(>z_250_50=t2,<z_200_0=t2); for (i = 1;i < 50;++i)
         * fe_sq(>z_250_50=t2,>z_250_50=t2);
         */
        fe_sq(t2, t2);
        for (i = 1; i < 50; ++i)
            fe_sq(t2, t2);
        ...
        /*
         * asm 1: fe_sq(>z_255_5=fe#2,<z_250_0=fe#2); for (i = 1;i < 5;++i)
         * fe_sq(>z_255_5=fe#2,>z_255_5=fe#2);
         */
        /*
         * asm 2: fe_sq(>z_255_5=t1,<z_250_0=t1); for (i = 1;i < 5;++i)
         * fe_sq(>z_255_5=t1,>z_255_5=t1);
         */
        fe_sq(t1, t1);
        for (i = 1; i < 5; ++i)
            fe_sq(t1, t1);
        ...
        /* asm 2: fe_mul(>z_255_21=,<z_255_5=t1,<z11=t0); */
        fe_mul(result, t1, t0);
     ...
     */
    public static void fe_sq(FieldElement h, FieldElement f)
    {
        int f0 = f.x0;
        int f1 = f.x1;
        int f2 = f.x2;
    ...
    public static void fe_mul(FieldElement h, FieldElement f, FieldElement g)
    {
        // System.out.print("\n F " + f.x0 + " : " + f.x1 + " : " + f.x2 + " : "
        // + f.x3 + " : " + f.x4 + " : " + f.x5 + " : " + f.x6 + " : " + f.x7 +
        // " : " + f.x8 + " : " + f.x9);
        // System.out.print("\n G " + g.x0 + " : " + g.x1 + " : " + g.x2 + " : "
        // + g.x3 + " : " + g.x4 + " : " + g.x5 + " : " + g.x6 + " : " + g.x7 +
        // " : " + g.x8 + " : " + g.x9);
    ...
    public static void fe_sub(FieldElement h, FieldElement f, FieldElement g)
    {
        int f0 = f.x0;
        int f1 = f.x1;
        int f2 = f.x2;
    ...
    public static void fe_pow22523(FieldElement result, FieldElement z)
    {
        FieldElement t0 = new FieldElement();
        FieldElement t1 = new FieldElement();
        FieldElement t2 = new FieldElement();
        ...
        /* qhasm: z22 = z11^2^1 */
        /*
         * asm 1: fe_sq(>z22=fe#1,<z11=fe#1); for (i = 1;i < 1;++i)
         * fe_sq(>z22=fe#1,>z22=fe#1);
         */
        /*
         * asm 2: fe_sq(>z22=t0,<z11=t0); for (i = 1;i < 1;++i)
         * fe_sq(>z22=t0,>z22=t0);
         */
        ...
        /* qhasm: z_10_5 = z_5_0^2^5 */
        /*
         * asm 1: fe_sq(>z_10_5=fe#2,<z_5_0=fe#1); for (i = 1;i < 5;++i)
         * fe_sq(>z_10_5=fe#2,>z_10_5=fe#2);
         */
        /*
         * asm 2: fe_sq(>z_10_5=t1,<z_5_0=t0); for (i = 1;i < 5;++i)
         * fe_sq(>z_10_5=t1,>z_10_5=t1);
         */
        fe_sq(t1, t0);
        for (i = 1; i < 5; ++i)
            fe_sq(t1, t1);
        ...
        /* qhasm: z_20_10 = z_10_0^2^10 */
        /*
         * asm 1: fe_sq(>z_20_10=fe#2,<z_10_0=fe#1); for (i = 1;i < 10;++i)
         * fe_sq(>z_20_10=fe#2,>z_20_10=fe#2);
         */
        /*
         * asm 2: fe_sq(>z_20_10=t1,<z_10_0=t0); for (i = 1;i < 10;++i)
         * fe_sq(>z_20_10=t1,>z_20_10=t1);
         */
        fe_sq(t1, t0);
        for (i = 1; i < 10; ++i)
            fe_sq(t1, t1);
        ...
        /* qhasm: z_40_20 = z_20_0^2^20 */
        /*
         * asm 1: fe_sq(>z_40_20=fe#3,<z_20_0=fe#2); for (i = 1;i < 20;++i)
         * fe_sq(>z_40_20=fe#3,>z_40_20=fe#3);
         */
        /*
         * asm 2: fe_sq(>z_40_20=t2,<z_20_0=t1); for (i = 1;i < 20;++i)
         * fe_sq(>z_40_20=t2,>z_40_20=t2);
         */
        fe_sq(t2, t1);
        for (i = 1; i < 20; ++i)
            fe_sq(t2, t2);
        ...
        /* qhasm: z_50_10 = z_40_0^2^10 */
        /*
         * asm 1: fe_sq(>z_50_10=fe#2,<z_40_0=fe#2); for (i = 1;i < 10;++i)
         * fe_sq(>z_50_10=fe#2,>z_50_10=fe#2);
         */
        /*
         * asm 2: fe_sq(>z_50_10=t1,<z_40_0=t1); for (i = 1;i < 10;++i)
         * fe_sq(>z_50_10=t1,>z_50_10=t1);
         */
        fe_sq(t1, t1);
        for (i = 1; i < 10; ++i)
            fe_sq(t1, t1);
        ...
        /* qhasm: z_100_50 = z_50_0^2^50 */
        /*
         * asm 1: fe_sq(>z_100_50=fe#2,<z_50_0=fe#1); for (i = 1;i < 50;++i)
         * fe_sq(>z_100_50=fe#2,>z_100_50=fe#2);
         */
        /*
         * asm 2: fe_sq(>z_100_50=t1,<z_50_0=t0); for (i = 1;i < 50;++i)
         * fe_sq(>z_100_50=t1,>z_100_50=t1);
         */
        fe_sq(t1, t0);
        for (i = 1; i < 50; ++i)
            fe_sq(t1, t1);
        ...
        /* qhasm: z_200_100 = z_100_0^2^100 */
        /*
         * asm 1: fe_sq(>z_200_100=fe#3,<z_100_0=fe#2); for (i = 1;i < 100;++i)
         * fe_sq(>z_200_100=fe#3,>z_200_100=fe#3);
         */
        /*
         * asm 2: fe_sq(>z_200_100=t2,<z_100_0=t1); for (i = 1;i < 100;++i)
         * fe_sq(>z_200_100=t2,>z_200_100=t2);
         */
        fe_sq(t2, t1);
        for (i = 1; i < 100; ++i)
            fe_sq(t2, t2);
        ...
        /* qhasm: z_250_50 = z_200_0^2^50 */
        /*
         * asm 1: fe_sq(>z_250_50=fe#2,<z_200_0=fe#2); for (i = 1;i < 50;++i)
         * fe_sq(>z_250_50=fe#2,>z_250_50=fe#2);
         */
        /*
         * asm 2: fe_sq(>z_250_50=t1,<z_200_0=t1); for (i = 1;i < 50;++i)
         * fe_sq(>z_250_50=t1,>z_250_50=t1);
         */
        fe_sq(t1, t1);
        for (i = 1; i < 50; ++i)
            fe_sq(t1, t1);
        ...
        /*
         * asm 1: fe_sq(>z_252_2=fe#1,<z_250_0=fe#1); for (i = 1;i < 2;++i)
         * fe_sq(>z_252_2=fe#1,>z_252_2=fe#1);
         */
        /*
         * asm 2: fe_sq(>z_252_2=t0,<z_250_0=t0); for (i = 1;i < 2;++i)
         * fe_sq(>z_252_2=t0,>z_252_2=t0);
         */
        fe_sq(t0, t0);
        for (i = 1; i < 2; ++i)
            fe_sq(t0, t0);
        ...
        /* asm 2: fe_mul(>z_252_3=,<z_252_2=t0,<z1=z); */
        fe_mul(result, t0, z);
    ...
    /*
     * Preconditions: |h| bounded by 1.1*2^26,1.1*2^25,1.1*2^26,1.1*2^25,etc.
     * 
     * Write p=2^255-19; q=floor(h/p). Basic claim: q = floor(2^(-255)(h + 19
     * 2^(-25)h9 + 2^(-1))).
     * 
     * Proof: Have |h|<=p so |q|<=1 so |19^2 2^(-255) q|<1/4. Also have |h-2^230
     * h9|<2^231 so |19 2^(-255)(h-2^230 h9)|<1/4.
     * 
     * Write y=2^(-1)-19^2 2^(-255)q-19 2^(-255)(h-2^230 h9). Then 0<y<1.
     * 
     * Write r=h-pq. Have 0<=r<=p-1=2^255-20. Thus
     * 0<=r+19(2^-255)r<r+19(2^-255)2^255<=2^255-1.
     * 
     * Write x=r+19(2^-255)r+y. Then 0<x<2^255 so floor(2^(-255)x) = 0 so
     * floor(q+2^(-255)x) = q.
     * 
     * Have q+2^(-255)x = 2^(-255)(h + 19 2^(-25) h9 + 2^(-1)) so
     * floor(2^(-255)(h + 19 2^(-25) h9 + 2^(-1))) = q.
     */
    public static void fe_tobytes(byte[] s, int offset, FieldElement h)
    {
    ...
    public static void fe_reduce(FieldElement hr, FieldElement h)
    {
        int h0 = h.x0;
        int h1 = h.x1;
        int h2 = h.x2;
    ...
    /*
     * return 1 if f == 0 return 0 if f != 0
     * 
     * Preconditions: |f| bounded by 1.1*2^26,1.1*2^25,1.1*2^26,1.1*2^25,etc.
     */
    // Todo: Discuss this with upstream
    // Above comment is from the original code. But I believe the original code
    // returned
    // 0 if f == 0
    // -1 if f != 0
    // This code actually returns 0 if f==0 and 1 if f != 0
    public static int fe_isnonzero(FieldElement f)
    {
        ...
        differentBits |= fr.x8;
        differentBits |= fr.x9;
        return (int) ((((int) differentBits - 1) >>> 31) ^ 1);
    }
     ...
     */
    public static void fe_neg(FieldElement h, FieldElement f)
    {
        int f0 = f.x0;
        int f1 = f.x1;
        int f2 = f.x2;
     ...
     * See fe_mul.c for discussion of implementation strategy.
     */
    public static void fe_sq2(FieldElement h, FieldElement f)
    {
        int f0 = f.x0;
        int f1 = f.x1;
        int f2 = f.x2;
