...
public class PaymentChannelServer {
    ...
    public interface ServerConnection {
         ...
         */
        public void channelOpen(Shake320Hash contractHash);
    ...
    @GuardedBy("lock") private Ed25519Key myKey;
    ...
    private void receiveVersionMessage(Protos.TwoWayChannelMessage msg) throws VerificationException {
        ...
        if (reopenChannelContractHash != null && reopenChannelContractHash.size() == 32) {
            Shake320Hash contractHash = new Shake320Hash(reopenChannelContractHash.toByteArray());
    ...
    private void multisigContractPropogated(Protos.ProvideContract providedContract, Shake320Hash contractHash) {
        lock.lock();
        try {
