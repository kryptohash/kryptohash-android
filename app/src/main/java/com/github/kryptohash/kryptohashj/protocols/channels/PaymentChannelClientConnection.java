...
import com.github.kryptohash.kryptohashj.core.Hasher256;
import com.github.kryptohash.kryptohashj.core.Utils;
import com.github.kryptohash.kryptohashj.core.Wallet;
import com.github.kryptohash.kryptohashj.net.NioClient;
import com.github.kryptohash.kryptohashj.net.ProtobufParser;
...
public class PaymentChannelClientConnection {
     ...
     * connection is open. The server is requested to keep the channel open for {@link com.github.kryptohash.kryptohashj.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW}
     ...
     */
    public PaymentChannelClientConnection(InetSocketAddress server, int timeoutSeconds, Wallet wallet, Ed25519Key myKey,
    ...
    public PaymentChannelClientConnection(InetSocketAddress server, int timeoutSeconds, Wallet wallet, Ed25519Key myKey,
        ...
        channelClient = new PaymentChannelClient(wallet, myKey, maxValue, new Sha3_256Hash(Hasher256.createDoubleHash(serverId.getBytes())), timeWindow,
