...
public class BlockChain extends AbstractBlockChain {
     ...
     * </p>
     *
     * <p>For the store, you should use {@link com.github.kryptohash.kryptohashj.store.SPVBlockStore} or you could also try a
     * {@link com.github.kryptohash.kryptohashj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
    ...
    @Override
    protected StoredBlock getStoredBlockInCurrentScope(Shake320Hash hash) throws BlockStoreException {
