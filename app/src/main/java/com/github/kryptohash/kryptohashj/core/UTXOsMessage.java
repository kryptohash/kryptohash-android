...
public class UTXOsMessage extends Message {
    private long height;
    private Shake320Hash chainHead;
     ...
     */
    public UTXOsMessage(NetworkParameters params, List<TransactionOutput> outputs, long[] heights, Shake320Hash chainHead, long height) {
        super(params);
