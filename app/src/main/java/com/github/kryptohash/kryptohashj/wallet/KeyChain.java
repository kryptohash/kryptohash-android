...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link com.github.kryptohash.kryptohashj.core.Wallet}. Key chains
...
public interface KeyChain {
    ...
    public List<? extends Ed25519Key> getKeys(KeyPurpose purpose, int numberOfKeys);

    /** Obtains a key intended for the given purpose. The chain may create a new key, derive one, or re-use an old one. */
    public Ed25519Key getKey(KeyPurpose purpose);
     ...
     *
     * <p>See the docs for {@link com.github.kryptohash.kryptohashj.core.BloomFilter#BloomFilter(int, double, long)} for a brief
