...
/**
 * This transaction signer resolves missing signatures in accordance with the given {@link com.github.kryptohash.kryptohashj.core.Wallet.MissingSigsMode}.
...
public class MissingSigResolutionSigner extends StatelessTransactionSigner {
    ...
    public boolean signInputs(ProposedTransaction propTx, KeyBag keyBag) {
        ...
        byte[] dummySig = TxEd25519Signature.dummy().encodeToKryptohash();
