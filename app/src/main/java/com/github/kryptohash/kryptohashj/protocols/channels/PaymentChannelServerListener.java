...
import com.github.kryptohash.kryptohashj.core.TransactionBroadcaster;
import com.github.kryptohash.kryptohashj.core.Wallet;
import com.github.kryptohash.kryptohashj.net.NioServer;
import com.github.kryptohash.kryptohashj.net.ProtobufParser;
import com.github.kryptohash.kryptohashj.net.StreamParserFactory;
    ...
    private class ServerHandler {
        public ServerHandler(final SocketAddress address, final int timeoutSeconds) {
            paymentChannelManager = new PaymentChannelServer(broadcaster, wallet, minAcceptedChannelSize, new PaymentChannelServer.ServerConnection() {
                ...
                @Override public void channelOpen(Shake320Hash contractHash) {
