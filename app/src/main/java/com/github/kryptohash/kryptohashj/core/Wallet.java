...
import com.github.kryptohash.kryptohashj.core.TransactionConfidence.ConfidenceType;
import com.github.kryptohash.kryptohashj.crypto.*;
import com.github.kryptohash.kryptohashj.params.UnitTestParams;
import com.github.kryptohash.kryptohashj.script.Script;
import com.github.kryptohash.kryptohashj.script.ScriptBuilder;
import com.github.kryptohash.kryptohashj.script.ScriptChunk;
import com.github.kryptohash.kryptohashj.signers.LocalTransactionSigner;
import com.github.kryptohash.kryptohashj.signers.MissingSigResolutionSigner;
import com.github.kryptohash.kryptohashj.signers.TransactionSigner;
import com.github.kryptohash.kryptohashj.store.UnreadableWalletException;
import com.github.kryptohash.kryptohashj.store.WalletProtobufSerializer;
import com.github.kryptohash.kryptohashj.utils.BaseTaggableObject;
import com.github.kryptohash.kryptohashj.utils.ExchangeRate;
...
import com.github.kryptohash.kryptohashj.wallet.*;
import com.github.kryptohash.kryptohashj.wallet.Protos.Wallet.EncryptionType;
import com.github.kryptohash.kryptohashj.wallet.WalletTransaction.Pool;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.github.kryptohash.kryptohashj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
    ...
    @VisibleForTesting final Map<Shake320Hash, Transaction> pending;
    @VisibleForTesting final Map<Shake320Hash, Transaction> unspent;
    @VisibleForTesting final Map<Shake320Hash, Transaction> spent;
    @VisibleForTesting final Map<Shake320Hash, Transaction> dead;

    // All transactions together.
    protected final Map<Shake320Hash, Transaction> transactions;
    ...
    private final LinkedHashMap<Shake320Hash, Transaction> riskDropped = new LinkedHashMap<Shake320Hash, Transaction>() {
        @Override
        protected boolean removeEldestEntry(Map.Entry<Shake320Hash, Transaction> eldest) {
            return size() > 1000;
        }
    };
    ...
    @Nullable private Shake320Hash lastBlockSeenHash;
    ...
    private transient HashSet<Shake320Hash> ignoreNextNewBlock;
     ...
     */
    public static Wallet fromWatchingKey(NetworkParameters params, DeterministicEd25519Key watchKey, long creationTimeSeconds) {
     ...
     * watching key corresponds to account zero in the recommended BIP32 key hierarchy.
     */
    public static Wallet fromWatchingKey(NetworkParameters params, DeterministicEd25519Key watchKey) {
    ...
    public Wallet(NetworkParameters params, KeyChainGroup keyChainGroup) {
        ...
        unspent = new HashMap<Shake320Hash, Transaction>();
        spent = new HashMap<Shake320Hash, Transaction>();
        pending = new HashMap<Shake320Hash, Transaction>();
        dead = new HashMap<Shake320Hash, Transaction>();
        transactions = new HashMap<Shake320Hash, Transaction>();
    ...
    private void createTransientState() {
        ignoreNextNewBlock = new HashSet<Shake320Hash>();
     ...
     * {@link com.github.kryptohash.kryptohashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
     * it's actually seen in a pending or confirmed transaction, at which point this method will start returning
     * a different key (for each purpose independently).
     */
    public DeterministicEd25519Key currentKey(KeyChain.KeyPurpose purpose) {
        keychainLock.lock();
        try {
            maybeUpgradeToHD();
    ...
    /**
     * An alias for calling {@link #currentKey(com.github.kryptohash.kryptohashj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.github.kryptohash.kryptohashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    public DeterministicEd25519Key currentReceiveKey() {
        return currentKey(KeyChain.KeyPurpose.RECEIVE_FUNDS);
    }

    /**
     * Returns address for a {@link #currentKey(com.github.kryptohash.kryptohashj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(com.github.kryptohash.kryptohashj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.github.kryptohash.kryptohashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link com.github.kryptohash.kryptohashj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link com.github.kryptohash.kryptohashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
     * into a receive coins wizard type UI. You should use this when the user is definitely going to hand this key out
     * to someone who wishes to send money.
     */
    public DeterministicEd25519Key freshKey(KeyChain.KeyPurpose purpose) {
     ...
     * to someone who wishes to send money.
     */
    public List<DeterministicEd25519Key> freshKeys(KeyChain.KeyPurpose purpose, int numberOfKeys) {
        List<DeterministicEd25519Key> keys;
        keychainLock.lock();
        try {
            maybeUpgradeToHD();
    ...
    /**
     * An alias for calling {@link #freshKey(com.github.kryptohash.kryptohashj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.github.kryptohash.kryptohashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    public DeterministicEd25519Key freshReceiveKey() {
        return freshKey(KeyChain.KeyPurpose.RECEIVE_FUNDS);
    }

    /**
     * Returns address for a {@link #freshKey(com.github.kryptohash.kryptohashj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(com.github.kryptohash.kryptohashj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.github.kryptohash.kryptohashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     */
    public List<Ed25519Key> getIssuedReceiveKeys() {
        keychainLock.lock();
        try {
    ...
    public List<Address> getIssuedReceiveAddresses() {
        final List<Ed25519Key> keys = getIssuedReceiveKeys();
     ...
     */
    public List<Ed25519Key> getImportedKeys() {
        keychainLock.lock();
        try {
    ...
    /**
     * <p>Deprecated alias for {@link #importKey(com.github.kryptohash.kryptohashj.core.Ed25519Key)}.</p>
     *
     * <p><b>Replace with either {@link #freshReceiveKey()} if your call is addKey(new Ed25519Key()), or with {@link #importKey(Ed25519Key)}
     * which does the same thing this method used to, but with a better name.</b></p>
     */
    @Deprecated
    public boolean addKey(Ed25519Key key) {
        return importKey(key);
    }

    /**
     * <p>Imports the given Ed25519Key to the wallet.</p>
     *
     ...
     */
    public boolean importKey(Ed25519Key key) {
    ...
    @Deprecated
    public int addKeys(List<Ed25519Key> keys) {
        return importKeys(keys);
    }

    /**
     * Imports the given keys to the wallet.
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.github.kryptohash.kryptohashj.wallet.WalletFiles.Listener)}
     ...
     */
    public int importKeys(final List<Ed25519Key> keys) {
        // API usage check.
    ...
    public int importKeysAndEncrypt(final List<Ed25519Key> keys, CharSequence password) {
        keychainLock.lock();
        try {
    ...
    public int importKeysAndEncrypt(final List<Ed25519Key> keys, KeyParameter aesKey) {
        keychainLock.lock();
        try {
            checkNoDeterministicKeys(keys);
     ...
     */
    public void addFollowingAccountKeys(List<DeterministicEd25519Key> followingAccountKeys) {
        keychainLock.lock();
        try {
     ...
     */
    public void addFollowingAccountKeys(List<DeterministicEd25519Key> followingAccountKeys, int threshold) {
        keychainLock.lock();
        try {
    ...
    /** See {@link com.github.kryptohash.kryptohashj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link com.github.kryptohash.kryptohashj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     */
    public DeterministicEd25519Key getWatchingKey() {
        keychainLock.lock();
        try {
            maybeUpgradeToHD();
     ...
     *
     * @return Ed25519Key object or null if no such key was found.
     */
    @Override
    @Nullable
     ...
     * @return Ed25519Key or null if no such key was found.
     */
    @Override
    @Nullable
     ...
     * See {@link com.github.kryptohash.kryptohashj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicEd25519Key)} for more info on this.
     */
     ...
     * @throws com.github.kryptohash.kryptohashj.core.Ed25519Key.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    public DeterministicSeed getKeyChainSeed() {
        ...
        try {
            ...
            if (seed == null)
                throw new Ed25519Key.MissingPrivateKeyException();
            return seed;
        } finally {
            keychainLock.unlock();
        }
     ...
     */
    public DeterministicEd25519Key getKeyByPath(List<ChildNumber> path) {
        keychainLock.lock();
        try {
            maybeUpgradeToHD();
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.github.kryptohash.kryptohashj.crypto.KeyCrypter,
     ...
     * (Used in encrypting/ decrypting an Ed25519Key).
     */
    @Nullable
    ...
    public boolean isConsistent() {
        ...
        try {
            ...
            Set<Shake320Hash> hashes = new HashSet<Shake320Hash>();
     ...
     */
    @Override
    public boolean notifyTransactionIsInBlock(Shake320Hash txHash, StoredBlock block,
    ...
    public void notifyNewBestBlock(StoredBlock block) throws VerificationException {
        ...
        Shake320Hash newBlockHash = block.getHeader().getHash();
     ...
     */
    @Nullable
    public Transaction getTransaction(Shake320Hash hash) {
        lock.lock();
        try {
    ...
    /** {@inheritDoc} */
    @Override
    public Map<Shake320Hash, Transaction> getTransactionPool(Pool pool) {
        lock.lock();
        try {
            switch (pool) {
                case UNSPENT:
     ...
     * replay) and makes the wallet think it has never seen a block.
     */
    public void reset() {
        lock.lock();
        try {
    ...
    public String toString(boolean includePrivateKeys, boolean includeTransactions, boolean includeExtensions, @Nullable AbstractBlockChain chain) {
        ...
        try {
            ...
            builder.append(String.format("Wallet containing %s KHC (available: %s KHC) in:%n",
    ...
    private void toStringHelper(StringBuilder builder, Map<Shake320Hash, Transaction> transactionMap,
     ...
     * of {@link com.github.kryptohash.kryptohashj.core.Ed25519Key#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    @Nullable
    public Shake320Hash getLastBlockSeenHash() {
        lock.lock();
        try {
    ...
    public void setLastBlockSeenHash(@Nullable Shake320Hash lastBlockSeenHash) {
        lock.lock();
        try {
     ...
     * you can use {@link com.github.kryptohash.kryptohashj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link com.github.kryptohash.kryptohashj.signers.TransactionSigner.MissingSignatureException}
         * will be thrown for P2SH and {@link Ed25519Key.MissingPrivateKeyException} for other tx types.
         */
        THROW
    }
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.github.kryptohash.kryptohashj.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * <p>Kryptohash requires a flat fee per transaction</p>
         */
        public Coin flatFee = null;

        /**
         * Flat fee is 0.4%. Divisor = (1 / 0.004) = 250
         */
        public final long flatFeeDivisor = (long)(1 / Transaction.FLAT_FEE_PER_TRANSACTION);

        /**
         * <p>Requires that there is enough flat fee.
         * Defaults to true since Kryptohash network rejects transaction without the minimum flat fee.
         * You should only set this to false if you know what you're doing. Example: ensuring the transaction
         * has enough fee it will not be outright rejected by the network.</p>
         */
        public boolean ensureFlatFee = true;
        ...
        /**
         * If not null, the {@link com.github.kryptohash.kryptohashj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
        ...
        public static SendRequest to(Address destination, Coin value) {
            ...
            req.flatFee = req.calcFlatFee(value);
            return req;
        }
         ...
         */
        public static SendRequest to(NetworkParameters params, Ed25519Key destination, Coin value) {
            SendRequest req = new SendRequest();
        ...
        public Coin calcFlatFee(Coin value) {
            Coin fee = value.divide(flatFeeDivisor);
            if (fee.isLessThan(Transaction.MIN_NONDUST_OUTPUT))
                fee = Transaction.MIN_NONDUST_OUTPUT;
            return fee;
        }
    ...
    public void completeTx(SendRequest req) throws InsufficientMoneyException {
        ...
        try {
            ...
            if (req.ensureMinRequiredFee && req.emptyWallet) {
                if (req.ensureFlatFee && req.flatFee == null)
                    req.flatFee = req.calcFlatFee(value);

                final Coin flatFee = req.flatFee == null ? Coin.ZERO : req.flatFee;
                final Coin baseFee = req.fee == null ? Coin.ZERO : req.fee;
                final Coin totalFee = baseFee.add(flatFee);
                final Coin feePerKb = req.feePerKb == null ? Coin.ZERO : req.feePerKb;
                Transaction tx = req.tx;
                if (!adjustOutputDownwardsForFee(tx, bestCoinSelection, totalFee, feePerKb))
    ...
    /** Reduce the value of the first output of a transaction to pay the given flatFee and feePerKb as appropriate for its size. */
    ...
    public void reorganize(StoredBlock splitPoint, List<StoredBlock> oldBlocks, List<StoredBlock> newBlocks) throws VerificationException {
        ...
        try {
            ...
            ArrayListMultimap<Shake320Hash, TxOffsetPair> mapBlockTx = ArrayListMultimap.create();
            for (Transaction tx : getTransactions(true)) {
                Map<Shake320Hash, Integer> appearsIn = tx.getAppearsInHashes();
                if (appearsIn == null) continue;  // Pending.
                for (Map.Entry<Shake320Hash, Integer> block : appearsIn.entrySet())
                    mapBlockTx.put(block.getKey(), new TxOffsetPair(tx, block.getValue()));
            }
            for (Shake320Hash blockHash : mapBlockTx.keySet())
                Collections.sort(mapBlockTx.get(blockHash));

            List<Shake320Hash> oldBlockHashes = new ArrayList<Shake320Hash>(oldBlocks.size());
            ...
            for (Shake320Hash blockHash : oldBlockHashes) {
                for (TxOffsetPair pair : mapBlockTx.get(blockHash)) {
                    Transaction tx = pair.tx;
                    final Shake320Hash txHash = tx.getHash();
                    if (tx.isCoinBase()) {
    ...
    public FeeCalculation calculateFee(SendRequest req, Coin value, List<TransactionInput> originalInputs,
        ...
        while (true) {
            ...
            // Add the Kryptohash Flat fee
            if (req.ensureFlatFee) {
                if (req.flatFee == null)
                    req.flatFee = req.calcFlatFee(value);

                fees = fees.add(req.flatFee);
            }
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.github.kryptohash.kryptohashj.core.TransactionBroadcaster broadcaster) {
    ...
    public boolean isKeyRotating(Ed25519Key key) {
     ...
     * @throws com.github.kryptohash.kryptohashj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
     ...
     * {@link com.github.kryptohash.kryptohashj.core.PeerFilterProvider} interface and generally should not be used directly by apps.
