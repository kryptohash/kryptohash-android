...
import com.github.kryptohash.kryptohashj.crypto.KeyCrypterScrypt;
...
import com.github.kryptohash.kryptohashj.utils.Fiat;
import com.github.kryptohash.kryptohashj.wallet.KeyChainGroup;
import com.github.kryptohash.kryptohashj.wallet.WalletTransaction;
...
public class WalletProtobufSerializer {
    ...
    public Protos.Wallet walletToProto(Wallet wallet) {
        ...
        Shake320Hash lastSeenBlockHash = wallet.getLastBlockSeenHash();
    ...
    private static Protos.Transaction makeTxProto(WalletTransaction wtx) {
        ...
        for (TransactionOutput output : tx.getOutputs()) {
            ...
            if (spentBy != null) {
                Shake320Hash spendingHash = spentBy.getParentTransaction().getHash();
        ...
        final Map<Shake320Hash, Integer> appearsInHashes = tx.getAppearsInHashes();
        if (appearsInHashes != null) {
            for (Map.Entry<Shake320Hash, Integer> entry : appearsInHashes.entrySet()) {
        ...
        synchronized (confidence) {
            ...
            if (confidence.getConfidenceType() == ConfidenceType.DEAD) {
                ...
                if (confidence.getOverridingTransaction() != null) {
                    Shake320Hash overridingHash = confidence.getOverridingTransaction().getHash();
    ...
    public static ByteString hashToByteString(Shake320Hash hash) {
        return ByteString.copyFrom(hash.getBytes());
    }

    public static Shake320Hash byteStringToHash(ByteString bs) {
        return new Shake320Hash(bs.toByteArray());
    }
    ...
    private void readTransaction(Protos.Transaction txProto, NetworkParameters params) throws UnreadableWalletException {
        ...
        if (txProto.hasTxTime()) {
            tx.setTxTime(0x7fffffffffffffffL & txProto.getTxTime());
        }
        ...
        Shake320Hash protoHash = byteStringToHash(txProto.getHash());
    ...
    private WalletTransaction connectTransactionOutputs(com.github.kryptohash.kryptohashj.wallet.Protos.Transaction txProto) throws UnreadableWalletException {
