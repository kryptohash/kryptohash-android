...
public class GetBlocksMessage extends Message {
    ...
    protected List<Shake320Hash> locator;
    protected Shake320Hash stopHash;

    public GetBlocksMessage(NetworkParameters params, List<Shake320Hash> locator, Shake320Hash stopHash) {
        super(params);
    ...
    public void parse() throws ProtocolException {
        ...
        if (startCount > 500)
            throw new ProtocolException("Number of locators cannot be > 500, received: " + startCount);
        locator = new ArrayList<Shake320Hash>(startCount);
    ...
    public List<Shake320Hash> getLocator() {
        return locator;
    }

    public Shake320Hash getStopHash() {
        return stopHash;
    }
    ...
    public int hashCode() {
        ...
        for (Shake320Hash aLocator : locator) hashCode ^= aLocator.hashCode();
