...
/**
 * Represents a monetary Kryptohash Coin value. This class is immutable.
 */
public final class Coin implements Monetary, Comparable<Coin>, Serializable {

    /**
     * Number of decimals for one KHC. This constant is useful for quick adapting to other coins because a lot of
     * constants derive from it.
     */
    public static final int SMALLEST_UNIT_EXPONENT = 5;

    /**
     * The number of Kryptoha-toshis equal to one KHC.
     */
    ...
    /**
     * 0.01 KHCs. This unit is not really used much.
     */
    public static final Coin CENT = COIN.divide(100);

    /**
     * 0.001 KHCs, also known as 1 mKHC.
     */
    public static final Coin MILLICOIN = COIN.divide(1000);

    /**
     * 0.000001 KHCs, also known as 1 µKHC or 1 uKHC.
     */
    /*
    ...
    */
    ...
    /**
     * A Kryptoha-toshi is the smallest unit that can be transferred. 100,000 of them fit into a KHC.
     */
    public static final Coin SATOSHI = Coin.valueOf(1);

    public static final Coin FIFTY_COINS = COIN.multiply(50);

    public static final Coin THOUSAND_COINS = COIN.multiply(1000);
    ...
    private Coin(final long satoshis) {
        checkArgument(-MAX_SATOSHIS <= satoshis && satoshis <= MAX_SATOSHIS,
            "%s satoshis exceeds maximum possible quantity of KHC.", satoshis);
        this.value = satoshis;
    }
    ...
    /**
     * Returns the number of kryptoha-toshis of this monetary value.
     */
    public long longValue() {
        return this.value;
    }

    private static final MonetaryFormat FRIENDLY_FORMAT = MonetaryFormat.BTC.minDecimals(2).repeatOptionalDecimals(1, 2).postfixCode();
