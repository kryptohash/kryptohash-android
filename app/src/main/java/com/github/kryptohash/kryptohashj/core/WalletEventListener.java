...
import com.github.kryptohash.kryptohashj.wallet.KeyChainEventListener;
...
public interface WalletEventListener extends KeyChainEventListener {
     ...
     * the object retrieved via {@link com.github.kryptohash.kryptohashj.core.Transaction#getConfidence()}. It's safe to modify the
