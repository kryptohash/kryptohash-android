...
import com.github.kryptohash.kryptohashj.store.FullPrunedBlockStore;
 ...
 * {@link com.github.kryptohash.kryptohashj.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    protected final Sha3_256Hash dataHash;
    ...
    private Sha3_256Hash readBinary(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            Sha3_256Hash dataHash = new Sha3_256Hash(digest.digest());
    ...
    private Sha3_256Hash readTextual(InputStream inputStream) throws IOException {
    ...
    public Sha3_256Hash getDataHash() {
        return dataHash;
    }
     ...
     *
     * <p>Note that time is adjusted backwards by 1 day to account for possible clock drift in the block headers.</p>
     */
