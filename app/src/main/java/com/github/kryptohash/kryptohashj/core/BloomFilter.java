...
public class BloomFilter extends Message {
     ...
     * See {@link com.github.kryptohash.kryptohashj.core.BloomFilter.BloomUpdate} for a brief description of each mode. The purpose
    ...
    public synchronized void insert(Ed25519Key key) {
    ...
    /**
     * Returns true if this filter will match anything. See {@link com.github.kryptohash.kryptohashj.core.BloomFilter#setMatchAll()}
    ...
    public synchronized FilteredBlock applyAndUpdate(Block block) {
        ...
        List<Shake320Hash> txHashes = new ArrayList<Shake320Hash>(txns.size());
