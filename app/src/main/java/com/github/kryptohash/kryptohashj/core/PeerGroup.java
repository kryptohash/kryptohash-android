...
import com.github.kryptohash.kryptohashj.crypto.DRMWorkaround;
import com.github.kryptohash.kryptohashj.net.BlockingClientManager;
import com.github.kryptohash.kryptohashj.net.ClientConnectionManager;
import com.github.kryptohash.kryptohashj.net.FilterMerger;
import com.github.kryptohash.kryptohashj.net.NioClientManager;
import com.github.kryptohash.kryptohashj.net.discovery.PeerDiscovery;
import com.github.kryptohash.kryptohashj.net.discovery.PeerDiscoveryException;
import com.github.kryptohash.kryptohashj.net.discovery.TorDiscovery;
import com.github.kryptohash.kryptohashj.script.Script;
import com.github.kryptohash.kryptohashj.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
    ...
    private final AbstractWalletEventListener walletEventListener = new AbstractWalletEventListener() {
        ...
        @Override public void onKeysAdded(List<Ed25519Key> keys) {
            queueRecalc(true);
        }
    ...
    private PeerGroup(NetworkParameters params, @Nullable AbstractBlockChain chain, ClientConnectionManager connectionManager, @Nullable TorClient torClient) {
        ...
        versionMessage = new VersionMessage(params, (long)height);
    ...
    public void setUserAgent(String name, String version, @Nullable String comments) {
        ...
        int height = chain == null ? 0 : chain.getBestChainHeight();
        VersionMessage ver = new VersionMessage(params, (long)height);
    ...
    protected void discoverPeers() throws PeerDiscoveryException {
        ...
        //log.info("Peer discovery took {}msec and returned {} items", System.currentTimeMillis() - start, addressList.size());
    }
     ...
     *         Use {@link com.github.kryptohash.kryptohashj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.github.kryptohash.kryptohashj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.github.kryptohash.kryptohashj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.github.kryptohash.kryptohashj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.github.kryptohash.kryptohashj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.github.kryptohash.kryptohashj.core.Peer#ping()}.
     */
