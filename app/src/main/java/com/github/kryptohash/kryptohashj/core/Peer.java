 ...
 * {@link com.github.kryptohash.kryptohashj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.github.kryptohash.kryptohashj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
    ...
    @GuardedBy("lock") @Nullable private List<Shake320Hash> awaitingFreshFilter;
    ...
    private final HashSet<Shake320Hash> pendingBlockDownloads = new HashSet<Shake320Hash>();
     ...
     * {@link com.github.kryptohash.kryptohashj.net.NioClientManager#openConnection(java.net.SocketAddress, com.github.kryptohash.kryptohashj.net.StreamParser)}
     * or
     * {@link com.github.kryptohash.kryptohashj.net.NioClient#NioClient(java.net.SocketAddress, com.github.kryptohash.kryptohashj.net.StreamParser, int)}.</p>
     *
    ...
    public Peer(NetworkParameters params, AbstractBlockChain blockChain, PeerAddress peerAddress, String thisSoftwareName, String thisSoftwareVersion) {
        this(params, new VersionMessage(params, (long)blockChain.getBestChainHeight()), blockChain, peerAddress);  // TODO: Convert height to long in blockchain
            ...
            for (int i = 0; i < m.getBlockHeaders().size(); i++) {
                ...
                if (!passedTime && !reachedTop) {
                    ...
                    try {
                        ...
                        this.lastGetBlocksBegin = Shake320Hash.ZERO_HASH;
                        blockChainDownloadLocked(Shake320Hash.ZERO_HASH);
                    } finally {
                        lock.unlock();
                    }
                    return;
        ...
        try {
            ...
            try {
                if (awaitingFreshFilter != null) {
                    ...
                    awaitingFreshFilter = new LinkedList<Shake320Hash>();
                    awaitingFreshFilter.add(m.getHash());
    ...
    public ListenableFuture<Block> getBlock(Shake320Hash blockHash) {
    ...
    public ListenableFuture<Transaction> getPeerMempoolTransaction(Shake320Hash hash) {
        // This does not need to be locked.
    ...
    // getblocks requests.
    @GuardedBy("lock")
    private Shake320Hash lastGetBlocksBegin, lastGetBlocksEnd;

    @GuardedBy("lock")
    private void blockChainDownloadLocked(Shake320Hash toHash) {
        ...
        List<Shake320Hash> blockLocator = new ArrayList<Shake320Hash>(51);
        ...
        Shake320Hash chainHeadHash = chainHead.getHeader().getHash();
     ...
     * Once the pong is received the value returned by {@link com.github.kryptohash.kryptohashj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.github.kryptohash.kryptohashj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.github.kryptohash.kryptohashj.core.Peer#ping()} has never
        ...
        try {
            ...
            ping().addListener(new Runnable() {
                ...
                public void run() {
                    ...
                    GetDataMessage getdata = new GetDataMessage(params);
                    for (Shake320Hash hash : awaitingFreshFilter)
