...
import com.github.kryptohash.kryptohashj.core.StoredTransactionOutput;
import com.github.kryptohash.kryptohashj.core.StoredUndoableBlock;
...
public interface FullPrunedBlockStore extends BlockStore {
     ...
     */
    StoredBlock getOnceUndoableStoredBlock(Shake320Hash hash) throws BlockStoreException;
     ...
     */
    StoredUndoableBlock getUndoBlock(Shake320Hash hash) throws BlockStoreException;
    
    /**
     * Gets a {@link StoredTransactionOutput} with the given hash and index, or null if none is found
     */
    StoredTransactionOutput getTransactionOutput(Shake320Hash hash, long index) throws BlockStoreException;
     ...
     */
    boolean hasUnspentOutputs(Shake320Hash hash, int numOutputs) throws BlockStoreException;
