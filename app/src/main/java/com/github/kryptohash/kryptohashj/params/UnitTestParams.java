 ...
 * {@link com.github.kryptohash.kryptohashj.core.Block#solve()} by setting difficulty to the easiest possible.
 */
public class UnitTestParams extends NetworkParameters {
    public UnitTestParams() {
        ...
        maxTarget = new BigInteger("0fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", 16);
        genesisBlock.setTxTime(System.currentTimeMillis());
        genesisBlock.setnTime(30000);
