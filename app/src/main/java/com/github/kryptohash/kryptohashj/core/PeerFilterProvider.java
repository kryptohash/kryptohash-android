 ...
 * Note that an implementer is responsible for calling {@link PeerGroup#recalculateFastCatchupAndFilter(com.github.kryptohash.kryptohashj.core.PeerGroup.FilterRecalculateMode)}
...
public interface PeerFilterProvider {
     ...
     * possible for the {@link com.github.kryptohash.kryptohashj.net.FilterMerger} to request the counts of a bunch of providers
