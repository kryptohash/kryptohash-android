...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link com.github.kryptohash.kryptohashj.crypto.MnemonicCode} for more
     ...
     *
     * @throws com.github.kryptohash.kryptohashj.crypto.MnemonicException if check fails
     */
