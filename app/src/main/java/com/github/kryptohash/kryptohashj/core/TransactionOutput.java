...
public class TransactionOutput extends ChildMessage implements Serializable {
     ...
     * {@link Transaction#addOutput(Coin, Ed25519Key)} instead of creating an output directly.
     */
    public TransactionOutput(NetworkParameters params, @Nullable Transaction parent, Coin value, Ed25519Key to) {
        this(params, parent, value, ScriptBuilder.createOutputScript(to).getProgram());
    }
     ...
     *
     * <p>You probably should use {@link com.github.kryptohash.kryptohashj.core.TransactionOutput#getMinNonDustValue()} which uses
