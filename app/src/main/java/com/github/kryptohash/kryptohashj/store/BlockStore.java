...
public interface BlockStore {
     ...
     */
    StoredBlock get(Shake320Hash hash) throws BlockStoreException;

    /**
     * Returns the {@link StoredBlock} that represents the top of the chain of greatest total work. Note that this
     * can be arbitrarily expensive, you probably should use {@link com.github.kryptohash.kryptohashj.core.BlockChain#getChainHead()}
     * or perhaps {@link com.github.kryptohash.kryptohashj.core.BlockChain#getBestChainHeight()} which will run in constant time and
