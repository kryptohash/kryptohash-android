...
public abstract class ServerConnectionEventHandler {
     ...
     * {@link StoredPaymentChannelServerStates#getChannel(com.github.kryptohash.kryptohashj.core.Shake320Hash)} with the id provided in
     * {@link ServerConnectionEventHandler#channelOpen(com.github.kryptohash.kryptohashj.core.Shake320Hash)}</p>
     */
     ...
     */
    public abstract void channelOpen(Shake320Hash channelId);
     ...
     * {@link ServerConnectionEventHandler#channelOpen(Shake320Hash)}.</p>
     *
