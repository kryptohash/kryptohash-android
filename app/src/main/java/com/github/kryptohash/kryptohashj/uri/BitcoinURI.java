...
package com.github.kryptohash.kryptohashj.uri;
...
public class BitcoinURI {
    ...
    public static final String BITCOIN_SCHEME = "kryptohash";
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        if (input.startsWith("kryptohash://")) {
            schemeSpecificPart = input.substring("kryptohash://".length());
        ...
        if (addressSplitTokens.length == 0)
            throw new BitcoinURIParseException("No data found after the kryptohash: prefix");
