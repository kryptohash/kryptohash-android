...
public class RedeemData {
    ...
    public final List<Ed25519Key> keys;

    private RedeemData(List<Ed25519Key> keys, Script redeemScript) {
        this.redeemScript = redeemScript;
        List<Ed25519Key> sortedKeys = new ArrayList<Ed25519Key>(keys);
        Collections.sort(sortedKeys, Ed25519Key.PUBKEY_COMPARATOR);
        this.keys = sortedKeys;
    }

    public static RedeemData of(List<Ed25519Key> keys, Script redeemScript) {
     ...
     */
    public static RedeemData of(Ed25519Key key, Script program) {
