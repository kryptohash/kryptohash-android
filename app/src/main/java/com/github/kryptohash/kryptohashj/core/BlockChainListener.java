...
public interface BlockChainListener {
     ...
     * us via either {@link #receiveFromBlock(Transaction, StoredBlock, com.github.kryptohash.kryptohashj.core.BlockChain.NewBlockType, int)}
     * or {@link #notifyTransactionIsInBlock(Shake320Hash, StoredBlock, com.github.kryptohash.kryptohashj.core.BlockChain.NewBlockType, int)}.
     ...
     */
    boolean notifyTransactionIsInBlock(Shake320Hash txHash, StoredBlock block,
                                       BlockChain.NewBlockType blockType,
                                       int relativityOffset) throws VerificationException;
}
