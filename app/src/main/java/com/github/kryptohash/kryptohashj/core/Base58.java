...
public class Base58 {
    ...
    /**
     * Encode an array of bytes as Base58 with an appended checksum
     */
    public static String encodeWithChecksum(byte[] input) {
        ...
        Sha3_256Hash checkSum = KryptohashUtils.doubleSha3_256(b, 0, input.length);
    ...
    public static byte[] decodeChecked(String input) throws AddressFormatException {
        ...
        Sha3_256Hash sha3_256Hash = KryptohashUtils.doubleSha3_256(bytes);
        //byte[] hash = copyOfRange(tmp, 0, 4);
        byte[] hash = sha3_256Hash.firstFourBytes();
