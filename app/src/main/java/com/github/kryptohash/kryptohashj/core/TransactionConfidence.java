 ...
 *
 * <p>TransactionConfidence is updated via the {@link com.github.kryptohash.kryptohashj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link com.github.kryptohash.kryptohashj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence implements Serializable {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link com.github.kryptohash.kryptohashj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        public enum ChangeReason {
            /**
             * Occurs when the type returned by {@link com.github.kryptohash.kryptohashj.core.TransactionConfidence#getConfidenceType()}
     ...
     * and so on. This information is useful for {@link com.github.kryptohash.kryptohashj.wallet.CoinSelector} implementations to risk analyze
