...
public class DumpedPrivateKey extends VersionedChecksummedBytes {
    ...
    // Used by Ed25519Key.getPrivateKeyEncoded()
    ...
    /**
     * Parses the given private key as created by the "dumpprivkey" Kryptohash C++ RPC.
     *
    ...
    /**
     * Returns an Ed25519Key created from this encoded private key.
     */
    public Ed25519Key getKey() {
        final Ed25519Key key = Ed25519Key.fromSeed(bytes);
