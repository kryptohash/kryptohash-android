...
class StoredTransactionOutPoint implements Serializable {
    ...
    StoredTransactionOutPoint(Shake320Hash hash, long index) {
        this.hash = hash;
        this.index = index;
    }
...
public class MemoryFullPrunedBlockStore implements FullPrunedBlockStore {
    ...
    private TransactionalHashMap<Shake320Hash, StoredBlockAndWasUndoableFlag> blockMap;
    private TransactionalMultiKeyHashMap<Shake320Hash, Integer, StoredUndoableBlock> fullBlockMap;
    ...
    public MemoryFullPrunedBlockStore(NetworkParameters params, int fullStoreDepth) {
        blockMap = new TransactionalHashMap<Shake320Hash, StoredBlockAndWasUndoableFlag>();
        fullBlockMap = new TransactionalMultiKeyHashMap<Shake320Hash, Integer, StoredUndoableBlock>();
    ...
    public synchronized void put(StoredBlock storedBlock, StoredUndoableBlock undoableBlock) throws BlockStoreException {
        Preconditions.checkNotNull(blockMap, "MemoryFullPrunedBlockStore is closed");
        Shake320Hash hash = storedBlock.getHeader().getHash();
    ...
    @Override
    @Nullable
    public synchronized StoredBlock getOnceUndoableStoredBlock(Shake320Hash hash) throws BlockStoreException {
        Preconditions.checkNotNull(blockMap, "MemoryFullPrunedBlockStore is closed");
        StoredBlockAndWasUndoableFlag storedBlock = blockMap.get(hash);
    ...
    @Override
    @Nullable
    public synchronized StoredUndoableBlock getUndoBlock(Shake320Hash hash) throws BlockStoreException {
    ...
    @Override
    @Nullable
    public synchronized StoredTransactionOutput getTransactionOutput(Shake320Hash hash, long index) throws BlockStoreException {
    ...
    @Override
    public synchronized boolean hasUnspentOutputs(Shake320Hash hash, int numOutputs) throws BlockStoreException {
