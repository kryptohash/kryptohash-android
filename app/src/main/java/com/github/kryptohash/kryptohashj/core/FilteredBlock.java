...
public class FilteredBlock extends Message {
    ...
    private List<Shake320Hash> cachedTransactionHashes = null;
    ...
    private Map<Shake320Hash, Transaction> associatedTransactions = new HashMap<Shake320Hash, Transaction>();
     ...
     */
    public List<Shake320Hash> getTransactionHashes() throws VerificationException {
        if (cachedTransactionHashes != null)
            return Collections.unmodifiableList(cachedTransactionHashes);
        List<Shake320Hash> hashesMatched = new LinkedList<Shake320Hash>();
    ...
    public Map<Shake320Hash, Transaction> getAssociatedTransactions() {
