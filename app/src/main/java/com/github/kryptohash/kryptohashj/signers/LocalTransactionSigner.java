 ...
 */
package com.github.kryptohash.kryptohashj.signers;

import com.github.kryptohash.kryptohashj.core.Ed25519Key;
import com.github.kryptohash.kryptohashj.core.ScriptException;
import com.github.kryptohash.kryptohashj.core.Transaction;
import com.github.kryptohash.kryptohashj.core.TransactionInput;
//import com.github.kryptohash.kryptohashj.crypto.DeterministicKey;
...
import com.github.kryptohash.kryptohashj.wallet.KeyBag;
import com.github.kryptohash.kryptohashj.wallet.RedeemData;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * <p>{@link TransactionSigner} implementation for signing inputs using keys from provided {@link com.github.kryptohash.kryptohashj.wallet.KeyBag}.</p>
 ...
 * <p>This signer always uses {@link com.github.kryptohash.kryptohashj.core.Transaction.SigHash#ALL} signing mode.</p>
 */
public class LocalTransactionSigner extends StatelessTransactionSigner {
    ...
    public boolean signInputs(ProposedTransaction propTx, KeyBag keyBag) {
        ...
        for (int i = 0; i < numInputs; i++) {
            ...
            Ed25519Key pubKey = redeemData.keys.get(0);
            if (pubKey instanceof DeterministicEd25519Key)
                propTx.keyPaths.put(scriptPubKey, (((DeterministicEd25519Key) pubKey).getPath()));

            Ed25519Key key;
            // Kryptohash
            if (pubKey.hasPrivKey())
                key = Ed25519Key.fromPrivateAndPublic(pubKey.getPrivKeyBytes(), pubKey.getPubKey());
            else {
            ...
            try {
                TxEd25519Signature signature = tx.calculateSignature(i, key, script, Transaction.SigHash.ALL, false);
                ...
                int sigIndex = 0;
                inputScript = scriptPubKey.getScriptSigWithSignature(inputScript, signature.encodeToKryptohash(), sigIndex);
                txIn.setScriptSig(inputScript);

            } catch (Ed25519Key.KeyIsEncryptedException e) {
                throw e;
            } catch (Ed25519Key.MissingPrivateKeyException e) {
