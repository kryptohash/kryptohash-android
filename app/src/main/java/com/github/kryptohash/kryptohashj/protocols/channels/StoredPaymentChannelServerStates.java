...
public class StoredPaymentChannelServerStates implements WalletExtension {
    ...
    @GuardedBy("lock") @VisibleForTesting final Map<Shake320Hash, StoredServerChannel> mapChannels = new HashMap<Shake320Hash, StoredServerChannel>();
     ...
     */
    public StoredServerChannel getChannel(Shake320Hash id) {
        lock.lock();
        try {
