...
import com.github.kryptohash.kryptohashj.utils.*;
import org.slf4j.*;
...
public class SPVBlockStore implements BlockStore {
    ...
    protected LinkedHashMap<Shake320Hash, StoredBlock> blockCache = new LinkedHashMap<Shake320Hash, StoredBlock>() {
        @Override
        protected boolean removeEldestEntry(Map.Entry<Shake320Hash, StoredBlock> entry) {
    ...
    protected LinkedHashMap<Shake320Hash, Object> notFoundCache = new LinkedHashMap<Shake320Hash, Object>() {
        @Override
        protected boolean removeEldestEntry(Map.Entry<Shake320Hash, Object> entry) {
    ...
    public StoredBlock getChainHead() throws BlockStoreException {
        ...
        try {
            if (lastChainHead == null) {
                byte[] headHash = new byte[40];
                buffer.position(8);
                buffer.get(headHash);
                Shake320Hash hash = new Shake320Hash(headHash);
    ...
    protected static final int RECORD_SIZE = 40 /* hash */ + StoredBlock.COMPACT_SERIALIZED_SIZE;
