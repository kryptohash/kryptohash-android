...
public class StoredServerChannel {
    ...
    StoredServerChannel(@Nullable PaymentChannelServerState state, Transaction contract, TransactionOutput clientOutput,
                        long refundTransactionUnlockTimeSecs, Ed25519Key myKey, Coin bestValueToMe, @Nullable byte[] bestValueSignature) {
    ...
    /**
     * If a handler is connected, call its {@link com.github.kryptohash.kryptohashj.protocols.channels.PaymentChannelServer#close()}
