 ...
 * See {@link com.github.kryptohash.kryptohashj.script.Script} for details. Also provides a method to convert them to a string.
 */
public class ScriptOpCodes {
    ...
    public static final int OP_SHA3_224 = 0xb0;
    public static final int OP_SHA3_256 = 0xb1;
    public static final int OP_SHAKE160 = 0xb2;
    public static final int OP_SHAKE320 = 0xb3;
    ...
    private static final Map<Integer, String> opCodeMap = ImmutableMap.<Integer, String>builder()
        ...
        .put(OP_SHA3_224, "SHA3_224")
        .put(OP_SHA3_256, "SHA3_256")
        .put(OP_SHAKE160, "SHAKE160")
        .put(OP_SHAKE320, "SHAKE320")
        .put(OP_NOP5, "NOP5")
        .put(OP_NOP6, "NOP6")
        .put(OP_NOP7, "NOP7")
        .put(OP_NOP8, "NOP8")
    ...
    private static final Map<String, Integer> opCodeNameMap = ImmutableMap.<String, Integer>builder()
        ...
        .put("SHA3_224", OP_SHA3_224)
        .put("SHA3_256", OP_SHA3_256)
        .put("SHAKE160", OP_SHAKE160)
        .put("SHAKE320", OP_SHAKE320)
        .put("NOP5", OP_NOP5)
        .put("NOP6", OP_NOP6)
        .put("NOP7", OP_NOP7)
        .put("NOP8", OP_NOP8)
