...
public class CurrencyPair {
  ...
  // KHC
  public static final CurrencyPair KHC_USD = new CurrencyPair(Currencies.KHC, Currencies.USD);
  public static final CurrencyPair KHC_BTC = new CurrencyPair(Currencies.KHC, Currencies.BTC);
  // end
